...
using CRMAdapter_CRM_E_ActivateMDIWin_ActivityStarted = CRMAdapter.CRM_E_ActivateMDIWin_ActivityStarted;

using CRMAdapter_CRM_E_GetCustInfo_ActivityStarted = CRMAdapter.CRM_E_GetCustInfo_ActivityStarted;

using CRMAdapter_CMR_E_CRMChild_Created = CRMAdapter.CMR_E_CRMChild_Created;

using CRMAdapter_CRM_E_CRMChild_Activated = CRMAdapter.CRM_E_CRMChild_Activated;

using CRMAdapter_CRM_E_CRMChild_Closing = CRMAdapter.CRM_E_CRMChild_Closing;

using CRMAdapter_CRM_E_CRMfrmLogin_Created = CRMAdapter.CRM_E_CRMfrmLogin_Created;

using CRMAdapter_CRM_E_IntMgr_InteractionStarted = CRMAdapter.CRM_E_IntMgr_InteractionStarted;

using CRMAdapter__GC_CRM = CRMAdapter._GC_CRM;

using System;

namespace CRMAdapter.Project
{
// Project-8D81CECAC9EB9F5
/// <summary>
/// OpenSpan project.
/// </summary>
[OpenSpan.Design.TargetEnvironmentAttribute(OpenSpan.Design.TargetEnvironment.Driver)]
[OpenSpan.Design.ComponentIdentityAttribute("Project-8D81CECAC9EB9F5")]
...
public sealed class CRMAdapter : OpenSpan.Runtime.RuntimeProject
{
	...
	{
		this.mId = new OpenSpan.Design.ComponentIdentity("Project-8D81CECAC9EB9F5");
	...
	// WindowsAdapter-8D81CECE07B5E03
	...
	public CRMAdapter_CRM_E_ActivateMDIWin_ActivityStarted CRM_E_ActivateMDIWin_ActivityStarted
	{
		get
		{
			return ((CRMAdapter_CRM_E_ActivateMDIWin_ActivityStarted)(this["CRM_E_ActivateMDIWin_ActivityStarted"]));
		}
	}
	
	// Automator-8D82E3DF03C3727
	public CRMAdapter_CRM_E_GetCustInfo_ActivityStarted CRM_E_GetCustInfo_ActivityStarted
	{
		get
		{
			return ((CRMAdapter_CRM_E_GetCustInfo_ActivityStarted)(this["CRM_E_GetCustInfo_ActivityStarted"]));
		}
	}
	
	// Automator-8D82DD123C796FF
	public CRMAdapter_CMR_E_CRMChild_Created CMR_E_CRMChild_Created
	{
		get
		{
			return ((CRMAdapter_CMR_E_CRMChild_Created)(this["CMR_E_CRMChild_Created"]));
		}
	}
	
	// Automator-8D81D0779E11E96
	public CRMAdapter_CRM_E_CRMChild_Activated CRM_E_CRMChild_Activated
	{
		get
		{
			return ((CRMAdapter_CRM_E_CRMChild_Activated)(this["CRM_E_CRMChild_Activated"]));
		}
	}
	
	// Automator-8D83EA9C336B529
	public CRMAdapter_CRM_E_CRMChild_Closing CRM_E_CRMChild_Closing
	{
		get
		{
			return ((CRMAdapter_CRM_E_CRMChild_Closing)(this["CRM_E_CRMChild_Closing"]));
		}
	}
	...
	public CRMAdapter_CRM_E_IntMgr_InteractionStarted CRM_E_IntMgr_InteractionStarted
	{
		get
		{
			return ((CRMAdapter_CRM_E_IntMgr_InteractionStarted)(this["CRM_E_IntMgr_InteractionStarted"]));
		}
	}
	
	// GlobalContainer-8D82D68F3747BE3
	public CRMAdapter__GC_CRM _GC_CRM
	{
		get
		{
			return ((CRMAdapter__GC_CRM)(this["_GC_CRM"]));
		}
	}
}
